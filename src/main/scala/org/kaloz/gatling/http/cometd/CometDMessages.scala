...
object CometDMessages {
  ...
  case class Handshake(channel: String = "/meta/handshake", version: String = "1.0", supportedConnectionTypes: List[String] = List("websocket", "long-polling", "callback-polling"), minimumVersion: Option[String] = Some("0.9"), id: Option[String] = Some("1"), advice: Option[Map[String, Any]] = Some(Map("timeout" -> 60000, "interval" -> 0)), ext: Option[Any] = None)
  ...
  case class Publish(channel: String, data: Any, clientId: Option[String] = None, id: Option[String] = None, ext: Option[Any] = None)
